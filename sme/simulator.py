...
class SimulatorConfig:
    """Configuration class for general simulators."""
...
class GeneralSimulator:
    ...
    def simulate(self) -> torch.Tensor:
        """Run simulation, considering breakpoints if provided."""
    ...
    def _simulate_with_breaks(self) -> torch.Tensor:
        """Simulate time series data with defined breakpoints."""
    ...
    def _simulate_regime_switching(self) -> torch.Tensor:
        """Simulate a regime-switching model."""
